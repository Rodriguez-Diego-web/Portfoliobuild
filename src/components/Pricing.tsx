...
// Full-width-style als inline-style
...
const Pricing = () => {
  ...
  return (
    <section id="pricing" style={fullWidthStyle} className="dark:text-white">
      {/* Full-width background */}
      <div className="bg-gray-50 dark:bg-dark-100" style={{
        ...bgStyle
      }}></div>
